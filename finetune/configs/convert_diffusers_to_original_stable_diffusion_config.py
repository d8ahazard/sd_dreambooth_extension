...
class ConvertDiffusersToOriginalStableDiffusionConfig(BaseConfig):
    ...
    use_safetensors: bool = Field(default=False, title='Use Safetensors', description='Save weights use safetensors, default is ckpt.')
