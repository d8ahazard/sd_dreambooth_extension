...
def render():
    ...
    manager.register_db_component("convert_diffusers_to_original_stable_diffusion", USE_SAFETENSORS, "use_safetensors", False, "Save weights use safetensors, default is ckpt.")