...
def render():
    ...
    manager.register_db_component("convert_lora_safetensor_to_diffusers", DEVICE, "device", False, "Device to use (e.g. cpu, cuda:0, cuda:1, etc.)")
    manager.register_db_component("convert_lora_safetensor_to_diffusers", DUMP_PATH, "dump_path", False, "Path to the output model.")
    manager.register_db_component("convert_lora_safetensor_to_diffusers", LORA_PREFIX_TEXT_ENCODER, "lora_prefix_text_encoder", False, "The prefix of text encoder weight in safetensors")
    manager.register_db_component("convert_lora_safetensor_to_diffusers", LORA_PREFIX_UNET, "lora_prefix_unet", False, "The prefix of UNet weight in safetensors")
    manager.register_db_component("convert_lora_safetensor_to_diffusers", TO_SAFETENSORS, "to_safetensors", False, "Whether to store pipeline in safetensors format or not.")