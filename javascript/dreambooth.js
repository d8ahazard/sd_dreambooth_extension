...
let db_titles = {
    ...
    "Lora UNET Rank": "The rank for the Lora UNET. Higher values lead to bigger files, but store more weights for better quality. Lower values lead to small files, but sacrifices quality. Depending on your precision (fp16 or fp32), filesize may vary.",
    "Lora Text Encoder Rank": "The rank for the Lora Text Encoder. Higher values lead to bigger files, but store more weights for better quality. Lower values lead to small files, but sacrifices quality. Depending on your precision (fp16 or fp32), filesize may vary.",
