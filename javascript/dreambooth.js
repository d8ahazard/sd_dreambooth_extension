...
new_titles = {
    ...
    "Preview Image Prompt": "The prompt to use when generating preview images.",
    "Preview Image Negative Prompt": "A negative prompt to use when generating preview images.",
